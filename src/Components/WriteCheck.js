...
const [open, setOpen] = useState(false);
    ...
    return(
      ...
      <Card sx={{maxWidth: "80%", borderRadius: "20px", padding: "20px 20px" }} >
            ...
            <br/>
            <input className="check" type="checkbox" id="blindCheck" onClick={onChangeBlindCheck}/>
            <label className="check-label">Tick the checkbox if the patient is blind </label>
            <br/>
            <input className="check" type="checkbox" id="eduCheck" onClick={onChangeEduCheck}/>
            <label className="check-label">Tick if subject has less than 12 years of education</label>
            <br/><br/>
