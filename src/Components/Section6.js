    ...
    return(
        <div className="screen">
                ...
                <CardContent>
                          ...
                          <input className="check" type="checkbox" id="lion" onChange={onChangeLionCheck}></input>
                          <img src="lion.png"></img>
                          <br/>
                          <input className="check" type="checkbox" id="rhino" onChange={onChangeRhinoCheck}></input>
                          <img src="rhino.png"></img>
                          <br/>
                          <input className="check" type="checkbox" id="camel" onChange={onChangeCamelCheck}></input>
                          <img src="camel.png"></img>
                          <br/>
                          <label>[{score} points]</label>
                  </CardContent>         
             </Card>
             <button className="next-button" onClick={()=> {navigate("/sec7");sessionStorage.setItem("lion", "0");sessionStorage.setItem("camel", "0");sessionStorage.setItem("rhino", "0");}}>Next</button>
            </div>
    );
}
