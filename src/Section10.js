...
function Section10(){
  ...
  function getScore() {
    ...
    sessionStorage.setItem("subtraction",temp.toString());

    var scoretemp = score + parseInt(sessionStorage.getItem("letters")) 
    + parseInt(sessionStorage.getItem("front")) + parseInt(sessionStorage.getItem("back"))
        ...
        <div className="screen">
                ...
                <Card sx={{minWidth: "80%", borderRadius: "20px", textAlign:"center"}}> 
                  <CardContent>
                    ...
                    <br/>
                    <input type="checkbox" id="one" onClick={onChangeoneCheck}/>
                    <label>93</label>
                    <input type="checkbox" id="two" onClick={onChangetwoCheck}/>
                    <label>86</label>
                    <input type="checkbox" id="three" onClick={onChangethreeCheck}/>
                    <label>79</label>
                    <input type="checkbox" id="four" onClick={onChangefourCheck}/>
                    <label>72</label>
                    <input type="checkbox" id="five" onClick={onChangefiveCheck}/>
                    <label>65</label>  
                    <br/><br/>
                    <label>[{score} points]</label>
                  </CardContent>         
             </Card>
             <button className="next-button" onClick={()=> {navigate("/sec11");}}>Next</button>
            </div>
    );
}
