        ...
        <div className="screen">
                ...
                <Card sx={{maxWidth: "85%", borderRadius: "20px", textAlign:"center"}}> 
                  <CardContent>
                    ...
                    <input className="check" type="checkbox" id="meas" onClick={onChangemeasCheck}/>
                    <label className = "check-label">Watch - Ruler</label>
                    <br/>
                    <label>[{score} points]</label>
                  </CardContent>         
             </Card>
             <button className="next-button" onClick={()=> {navigate("/sec14");sessionStorage.setItem("trans", "0");sessionStorage.setItem("meas", "0");}}>Next</button>
            </div>
    );
}
