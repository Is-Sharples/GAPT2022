...
function Section5(){
    ...
    return(
        <div className="screen">
          ...
          <Card sx={{maxWidth: "80%", borderRadius: "20px", justifyContent:"center", textAlign: "center"}}>
            ...
            <Card sx={{display: "flex", minWidth: "80%", borderRadius: "20px", justifyContent:"center"}}> 
                <CardContent>
                <input type="checkbox" id="clock1" onChange={onChangeClock1Check}/>
                <label>Contour </label> 
                <br/>
                <input type="checkbox" id="clock2" onChange={onChangeClock2Check}/>
                <label>Numbers </label> 
                <br/>
                <input type="checkbox" id="clock3" onChange={onChangeClock3Check}/>
                <label>Hands </label>
                <br/>
        ...
        <button className="next-button" onClick={() => {navigate("/sec6");}}>Next</button>   
    </div> 
    );
}
