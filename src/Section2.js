                ...
                <Card sx={{minWidth: "75%", borderRadius: "20px", padding: "5px 20px"}} >
                    <h3>Social Habits:</h3>
                        <br/>
                          ...
                          <label>MyoCardialInfection</label>
                          <br/>
                          ...
                          <br/>
                          <input type="checkbox" onChange={() => handleOnChange(5)}/>
                          <label>Chronic Pulmonary Disease</label>
                          <br/>
                          <input type="checkbox" onChange={() => handleOnChange(6)}/>
                          <label>Rheumatic Disease</label>
                          <br/>
                          <input type="checkbox"  onChange={() => handleOnChange(7)}/>
                          <label>Peptic Ulcer Disease</label>
                          <br/>
                          <input type="checkbox" id="liver1" onChange={() => {handleOnChange(8); LiverCheck();}}/>
                          <label>Liver Disease, mild</label>
                          <br/>
                          <input type="checkbox" id="diabetes1" onChange={() => {handleOnChange(9); DiabetesCheck();}}/>
                          <label>Diabetes without chronic complications</label>
                          <br/>
                          <input type="checkbox" id="renal1" onChange={() => {handleOnChange(10); RenalCheck();}}/>
                          <label>Renal Disease, mild to moderate</label>
                          <br/>
                          <input type="checkbox" id="diabetes2"  onChange={() => {handleOnChange(11); DiabetesCheck2();}}/>
                          <label>Diabetes with chronic complications</label>
                          <br/>
                          <input type="checkbox" onChange={() => handleOnChange(12)}/>
                          <label>Hemiplegia or Paraplegia</label>
                          <br/>
                          <input type="checkbox" id="mal1" onChange={() => {handleOnChange(13)}}/>
                          <label>Any Malignancy</label>
                          <br/>
                          <input type="checkbox" id="liver2" onChange={() => {handleOnChange(14); LiverCheck2();}}/>
                          <label>Liver Disease, moderate to severe</label>
                          <br/>
                          <input type="checkbox" id="renal2" onChange={() => {handleOnChange(15); RenalCheck2();}}/>
                          <label>Renal Disease, severe</label>
                          <br/>
                          <input type="checkbox" id="hiv1" onChange={() => {handleOnChange(16); HivCheck();}}/>
                          <label>HIV Infection, no AIDS</label>
                          <br/>
                          <input type="checkbox" id="mal2" onChange={() => {handleOnChange(17); checkMutuallyInclusive();}}/>
                          <label>Metastatic Solid Tumor</label>
                          <br/>
                          <input type="checkbox" id="hiv2" onChange={() => {handleOnChange(18); HivCheck2();}}/>
                          <label>AIDS</label>
                          <br/><br/>
